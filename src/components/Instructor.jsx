...
import { RiSafariFill, RiStarFill } from 'react-icons/ri'

const Instructor = ({id, name, specialty, pic, rating}) => {
  return (
    <div className='group flex flex-col gap-y-4 p-4 rounded-4xl border border-solid border-transparent hover:border-gray-10 transition-colors duration-300'
    data-id={id}>
      ...
      <div className='flex flex-col gap-y-4'>
          <div className='flex flex-col'>
              <div className='flex justify-between'>
                  <p className='mb-105 text-lg text-gray-10'>
                      {name}
                  </p>
              ...
              <a href='#' 
                 className='group/view-btn btn btn-outline flex items-center justify-center gap-x-2 !w-full'>
                  ...
                  <svg width="71" height="51" viewBox="0 0 71 51" fill="none" xmlns="http://www.w3.org/2000/svg"
                    className='w-[26px]'>
                      <path d="M0.612732 25.4016H64.4928M38.4571 1.9472C43.2016 10.3343 51.0356 19.7372 64.4928 25.4472C51.0356 31.1572 43.2016 40.5601 38.4571 48.9472" 
                      stroke="#292C32" 
                      strokeWidth="4.5"
